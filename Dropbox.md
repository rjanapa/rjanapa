...
<b>Synchronization Service:</b> Synchronization mechanism to notify all clients whenever an update happens so they can synchronize their files. Synchronization Servers handle the workflow of notifying all clients about different changes for synchronization.
